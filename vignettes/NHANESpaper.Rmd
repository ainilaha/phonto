...
The database can easily be queried to perform across cycle analyses. In Figure \@ref(fig:demoplot) we summarize the number of participants by recorded ethnicity and gender by cycle.
...
The column names for each of these metadata tables are are given in the tables below. 
