...
\<design decision to support nhanesA as an out of DB alternative\>

\<maybe talk about why we did the DB a little more and how we ended up on the design\>

In this paper, we describe our work to develop a system using Docker, Postgres and RStudio to enhance the discovery process and facilitate reproducibility and cross-dataset integration.  This work is related to and has benefited from previous work done at the Center For Computational Biomedicine (https://github.com/ccb-hms/nhanes-database).
